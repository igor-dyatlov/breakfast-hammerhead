				       ...
				       u32 *copyback, bool kcal)
{
	 ...
	 * function is expected to proceed anyway to update data in MDSS
	 * registers, just ignore the absence of panel control data and ommit
	...
	if (unlikely(config->block < MDP_LOGICAL_BLOCK_DISP_0 ||

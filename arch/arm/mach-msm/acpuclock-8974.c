...
static struct acpu_level acpu_freq_tbl_2p5g_pvs0[] __initdata = {
	...
	{ 1, { 2342400, HFPLL, 1, 122 }, L2(20), 1125000, 723 },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(21), 1140000, 755 },
	{ 1, { 2457600, HFPLL, 1, 128 }, L2(22), 1150000, 786 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p5g_pvs1[] __initdata = {
	...
	{ 1, { 2342400, HFPLL, 1, 122 }, L2(20), 1100000, 723 },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(21), 1115000, 755 },
	{ 1, { 2457600, HFPLL, 1, 128 }, L2(22), 1125000, 786 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p5g_pvs2[] __initdata = {
	...
	{ 1, { 2342400, HFPLL, 1, 122 }, L2(20), 1075000, 723 },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(21), 1090000, 755 },
	{ 1, { 2457600, HFPLL, 1, 128 }, L2(22), 1100000, 786 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p5g_pvs3[] __initdata = {
	...
	{ 1, { 2342400, HFPLL, 1, 122 }, L2(20), 1050000, 723 },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(21), 1065000, 755 },
	{ 1, { 2457600, HFPLL, 1, 128 }, L2(22), 1075000, 786 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p5g_pvs4[] __initdata = {
	...
	{ 1, { 2342400, HFPLL, 1, 122 }, L2(20), 1025000, 723 },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(21), 1040000, 755 },
	{ 1, { 2457600, HFPLL, 1, 128 }, L2(22), 1050000, 786 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p5g_pvs5[] __initdata = {
	...
	{ 1, { 2342400, HFPLL, 1, 122 }, L2(20), 1000000, 723 },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(21), 1015000, 755 },
	{ 1, { 2457600, HFPLL, 1, 128 }, L2(22), 1025000, 786 },
	{ 0, { 0 } }
};
...
static struct acpu_level acpu_freq_tbl_2p5g_pvs6[] __initdata = {
	...
	{ 1, { 2342400, HFPLL, 1, 122 }, L2(20),  975000, 723 },
	{ 1, { 2419200, HFPLL, 1, 126 }, L2(21),  990000, 755 },
	{ 1, { 2457600, HFPLL, 1, 128 }, L2(22), 1000000, 786 },
	{ 0, { 0 } }
};
...
static struct pvs_table pvs_v2[NUM_SPEED_BINS][NUM_PVS] __initdata = {
	...
	/*
	 * 8974v2 2.5GHz Parts.
	 * Boost voltages by 10mV as middle frequencies are used.
	 */
	[1][0] = { acpu_freq_tbl_2p5g_pvs0, sizeof(acpu_freq_tbl_2p5g_pvs0), 10000 },
	[1][1] = { acpu_freq_tbl_2p5g_pvs1, sizeof(acpu_freq_tbl_2p5g_pvs1), 10000 },
	[1][2] = { acpu_freq_tbl_2p5g_pvs2, sizeof(acpu_freq_tbl_2p5g_pvs2), 10000 },
	[1][3] = { acpu_freq_tbl_2p5g_pvs3, sizeof(acpu_freq_tbl_2p5g_pvs3), 10000 },
	[1][4] = { acpu_freq_tbl_2p5g_pvs4, sizeof(acpu_freq_tbl_2p5g_pvs4), 10000 },
	[1][5] = { acpu_freq_tbl_2p5g_pvs5, sizeof(acpu_freq_tbl_2p5g_pvs5), 10000 },
	[1][6] = { acpu_freq_tbl_2p5g_pvs6, sizeof(acpu_freq_tbl_2p5g_pvs6), 10000 },
	[1][7] = { acpu_freq_tbl_2p5g_pvs6, sizeof(acpu_freq_tbl_2p5g_pvs6), 10000 },
